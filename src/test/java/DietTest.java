...
public class DietTest {
  ...
  public void calculate_number_of_calories_of_a_meal() {
    Assert.assertEquals(50, diet.calculCalories("egg"));
    Assert.assertEquals(250, diet.calculCalories("egg,seafood"));
  }

  @Test
  public void meal_calories_equal_to__the_average() {
    Assert.assertEquals("good, number of calories as expected",
        diet.evaluateCalories("seafood,egg,fruit,vegetable"));
  }

  @Test
  public void meal_calories_less_than_the_average() {
    Assert.assertEquals("still 300 calories to be added", diet.evaluateCalories("egg,fruit"));
  }

  @Test
  public void meal_calories_great_than_the_average() {
    Assert.assertEquals("still 100 calories to be removed",
        diet.evaluateCalories("seafood,egg,fruit,vegetable,cheese,peanut"));
  }

  @Test
  public void meal_contains_all_required_nutrients() {
    Assert.assertEquals("good, your meal contains all required nutrients!",
        diet.evaluateNutrients("egg,fruit,peanut"));
  }

  @Test
  public void missing_nutrient_in_the_meal() {
    Assert.assertEquals("your meal doesn't contain fats!", diet.evaluateNutrients("egg,fruit"));
  }

  @Test
  public void missing_two_nutrient_in_the_meal() {
    Assert.assertEquals("your meal doesn't contain carbohydrates and fats!",
        diet.evaluateNutrients("egg"));
  }
}
