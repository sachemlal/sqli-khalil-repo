...
public class DietTest {
   ...
   public void calculate_number_of_calories_of_a_meal(){
    ...
    public void meal_calories_equal_to__the_average(){
        Assert.assertEquals("good, number of calories as expected", diet.evaluateCalories("seafood,egg,fruit,vegetable"));
    }
    ...
    public void meal_calories_great_than_the_average(){
        Assert.assertEquals("still 100 calories to be removed", diet.evaluateCalories("seafood,egg,fruit,vegetable,cheese,peanut"));
    }

    @Test
    public void meal_contains_all_required_nutrients(){
        Assert.assertEquals("good, your meal contains all required nutrients!", diet.evaluateNutrients("egg,fruit,peanut"));
    }
